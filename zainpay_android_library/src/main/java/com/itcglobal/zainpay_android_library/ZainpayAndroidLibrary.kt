...
//    }
    ...
    fun getDepositVerification(token: String, txnRef: String) : JSONObject? {
        ...
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
            .url("${central.urlVerifyDepositTransactionV2}/$txnRef")
            .build()
    ...
    //count: String, txnType:String, dateFrom:String, dateTo:String
//    @RequiresApi(Build.VERSION_CODES.N)
    fun getVirtualAccTransactions(token: String, accountNumber:String, count: String, txnType:String, dateFrom:String, dateTo:String) : JSONObject? {
        //val count = Optional.ofNullable(count)
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
            .url("${central.urlGetVirtualAccTransactions}/$accountNumber")
            .build()
        jsonObject = try {
            val reply = client.newCall(request).execute()
            val result = reply.body!!.string()
    ...
    fun getVirtualAccTransactions(token: String, accountNumber:String, txnType:String, dateFrom:String, dateTo:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
    ...
    fun getVirtualAccTransactions(token: String, accountNumber:String, dateFrom:String, dateTo:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
    ...
    fun getVirtualAccTransactions(token: String, accountNumber:String, dateFrom:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
    ...
    fun getVirtualAccTransactions(token: String, accountNumber:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
...
//    zainboxTransactionList(string $zainboxCode, int $count = 20, ?string $accountNumber, ?string $txnType,  ?string $dateFrom,  ?string $dateTo)
    fun getZainboxTnxHistory(token: String, zainboxCode:String, accountNumber:String, count: String, txnType:String, dateFrom:String, dateTo:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
    ...
    fun getZainboxTnxHistory(token: String, zainboxCode:String, count: String, txnType:String, dateFrom:String, dateTo:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
    ...
    fun getZainboxTnxHistory(token: String, zainboxCode:String, txnType:String, dateFrom:String, dateTo:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
    ...
    fun getZainboxTnxHistory(token: String, zainboxCode:String, dateFrom:String, dateTo:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
    ...
    fun getZainboxTnxHistory(token: String, zainboxCode:String, dateFrom:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
...
//    merchantTransactionList($count = 20, ?string $accountNumber, ?string $txnType,  ?string $dateFrom,  ?string $dateTo)
     fun getMerchantTransaction(token: String, accountNumber:String, count: String, txnType:String, dateFrom:String, dateTo:String) : JSONObject? {
         val jsonObject: JSONObject?
         val request = Request.Builder()
             .addHeader("Authorization", "Bearer $token")
             .method("GET", null)
    ...
    fun getMerchantTransaction(token: String, count: String, txnType:String, dateFrom:String, dateTo:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
    ...
    fun getMerchantTransaction(token: String, count: String, dateFrom:String, dateTo:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
    ...
    fun getMerchantTransaction(token: String, count: String, dateFrom:String) : JSONObject? {
        val jsonObject: JSONObject?
        val request = Request.Builder()
            .addHeader("Authorization", "Bearer $token")
            .method("GET", null)
