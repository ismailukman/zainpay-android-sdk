...
class NetworkVar {
    ...
    var urlVerifyDepositTransaction = "$baseUrl/virtual-account/wallet/deposit/verify"
    var urlTransferFund = "$baseUrl/bank/transfer/"
    var urlBankList = "$baseUrl/bank/list"
    var urlTransferNameEnquiry = "$baseUrl/bank/name-enquiry"
    ...
    var urlVerifyDepositTransactionV2 = "$baseUrl/virtual-account/wallet/deposit/verify/v2"
